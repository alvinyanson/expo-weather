...
const translations = {
  en: {
    ...
    backgroundRefreshLabel: 'Background Weather Refresh',
    backgroundRefreshDesc: 'Fetch weather updates periodically when app is closed',
    backgroundNotificationTitle: 'Weather Update',
    backgroundNotificationBody: 'Weather condition has updated to %{condition} (%{temp}%{unit}).',
  ...
  ja: {
    ...
    backgroundRefreshLabel: 'バックグラウンド天気更新',
    backgroundRefreshDesc: 'アプリ終了時も定期的に天気情報を更新します',
    backgroundNotificationTitle: '天気情報の更新',
    backgroundNotificationBody: '天気が%{condition}に変わりました（%{temp}%{unit}）。',
